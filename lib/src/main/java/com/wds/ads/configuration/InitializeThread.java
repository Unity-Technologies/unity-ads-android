...
import com.wds.ads.broadcast.BroadcastMonitor;
import com.wds.ads.cache.CacheThread;
import com.wds.ads.connectivity.ConnectivityMonitor;
import com.wds.ads.connectivity.IConnectivityListener;
import com.wds.ads.device.AdvertisingId;
...
public class InitializeThread extends Thread {
  ...
  public static class InitializeStateLoadWeb extends InitializeState {
    ...
    public InitializeState execute() {
      ...
      if (webViewHash != null && !Utilities.Sha256(webViewData)
        .equals(webViewHash)) {
