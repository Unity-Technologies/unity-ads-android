package com.wds.ads.test.environment;
...
import com.wds.ads.test.TestUtilities;
...
public class EnvironmentTest extends ActivityInstrumentationTestCase2<AdUnitActivity> {
  ...
  public void testWifiEnabled() {
    ...
    mConnectivity = (ConnectivityManager) InstrumentationRegistry.getTargetContext()
      .getSystemService(Context.CONNECTIVITY_SERVICE);
    TelephonyManager mTelephony;
    mTelephony = (TelephonyManager) InstrumentationRegistry.getTargetContext()
    ...
    if (mConnectivity != null) {
      ...
      if (!mConnectivity.getBackgroundDataSetting() || !mConnectivity.getActiveNetworkInfo()
        .isConnected() || mTelephony == null) {
        isWifi = false;
      }
    }
