...
public class SdkPropertiesTest {
  ...
  public void testCacheDirectory() {
    ...
    assertNotNull("getCacheDirectory.getAbsolutePath() should not ever return null", SdkProperties.getCacheDirectory()
      .getAbsolutePath());
    assertTrue("getCacheDirectory.getAbsolutePath() should not ever return null", SdkProperties.getCacheDirectory()
      .getAbsolutePath()
      .length() > 10);
  }
  ...
  public void testCacheDirectoryName() {
    ...
    assertEquals("cacheDirectoryName should be " + "UnityAdsCache".length() + " characters long", "UnityAdsCache".length(), SdkProperties.getCacheDirectoryName()
      .length());
