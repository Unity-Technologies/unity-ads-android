...
import com.wds.ads.api.Request;
import com.wds.ads.properties.ClientProperties;
import com.wds.ads.request.WebRequestError;
import com.wds.ads.request.WebRequestEvent;
...
public class RequestTest {
  ...
  public void testValidPostWithValidHeadersAndPostBody() throws Exception {
    ...
    for (int i = 0; i < receivedHeaders.length(); i++) {
      if (((JSONArray) receivedHeaders.get(i)).get(0)
        .equals("test-header") && ((JSONArray) receivedHeaders.get(i)).get(1)
        .equals("test")) {
